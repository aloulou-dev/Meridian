...
extension CoreDataService {
    func seedSampleEntries() {
        ...
        let seeds: [SeedEntry] = [
            ...
            SeedEntry(daysAgo: 6, type: .morning, hour: 7, content: morningTexts[5]),
            ...
            SeedEntry(daysAgo: 8, type: .night, hour: 22, content: nightTexts[6]),
            ...
            SeedEntry(daysAgo: 11, type: .morning, hour: 7, content: morningTexts[8]),
            ...
            SeedEntry(daysAgo: 18, type: .morning, hour: 7, content: morningTexts[9]),
            SeedEntry(daysAgo: 18, type: .night, hour: 21, content: nightTexts[9]),
            ...
            SeedEntry(daysAgo: 30, type: .morning, hour: 8, content: morningTexts[0]),
        ]
